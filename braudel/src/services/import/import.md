...
| **`geojson-catalog-service.ts`** | Registre unifié et moteur de recherche des fonds GeoJSON (49 époques Géopolitica, territoires, ZEE) | [geojson-catalog-service.md](./geojson-catalog-service.md) |
